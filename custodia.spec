...
install -m 644 -t "%{buildroot}/%{_defaultdocdir}/custodia/examples" custodia.conf httpd-custodia-gssapi.conf custodia-ipa.conf
...
%doc %{_defaultdocdir}/custodia/examples/custodia-ipa.conf
%license LICENSE
